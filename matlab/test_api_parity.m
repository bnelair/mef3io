...
%       run('<repo>/matlab/test_api_parity.m')
    ...
    readerMap = struct( ...
        ...
        'info', 'info', 'metadata', 'metadata', 'segments', 'segments', ...
        'toc', 'toc', 'records', 'records', 'problems', 'problems', ...
        'close', 'delete');
    writerMap = struct( ...
        'write', 'write', 'write_int32', 'writeInt32', ...
        'write_annotations', 'writeAnnotations', 'set_metadata', 'setMetadata', ...
        'close', 'delete');
    ...
    % extract_session / recover_session <-> MATLAB archiveSession /
    % extractSession / recoverSession, documented.
    for fn = {'archiveSession', 'extractSession', 'recoverSession'}
        name = ['mef3io.' fn{1}];
