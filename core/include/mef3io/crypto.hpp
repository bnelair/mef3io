...
//
// For how MEF encryption actually behaves (it is an all-or-nothing pairing —
// section 2 with the L1 key, section 3 with the L2 key — and "level-1 only" is
// not a valid file), see docs/encryption_model.md.
#pragma once
